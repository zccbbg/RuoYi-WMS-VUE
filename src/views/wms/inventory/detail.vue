<template>
  <div class="app-container bg-container">
    <el-card>
      <el-form class="form-wrapper" :model="queryParams" :inline="true" :label-width="70" ref="queryRef">
        <div class="formSearch">
          <el-form-item label="维度" prop="itemId" class="col1">
            <el-radio-group v-model="queryType" style="width: 100%" @change="handleSortTypeChange">
              <el-radio-button label="warehouse" class="radio-btn-2">仓库库区</el-radio-button>
              <el-radio-button label="item" class="radio-btn-2">商品</el-radio-button>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="仓库" prop="warehouseId" class="col1">
          ...
          <el-form-item label="库区" prop="areaId" class="col1">
          ...
          <el-form-item class="col1"  label="入库日期" prop="createTimeRange">
            <el-date-picker
