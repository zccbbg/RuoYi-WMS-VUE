    ...
    <el-card>
      <el-form :model="queryParams" class="form-wrapper" ref="queryRef" :inline="true" label-width="68px">
        <div class="formSearch">
          <el-form-item label="入库类型" prop="receiptOrderStatus" class="fixed-search">
            <el-radio-group v-model="queryParams.receiptOrderType" @change="handleQuery" style="width: 100%">
              <el-radio-button
                :key="-1"
                :label="-1"
                class="radio-btn-5"
          ...
          <el-form-item label="入库单号" prop="receiptOrderNo" class="col1">
            <el-input
          ...
          <el-form-item label="入库状态" prop="receiptOrderStatus" class="col0">
            <el-radio-group v-model="queryParams.receiptOrderStatus" @change="handleQuery" style="width: 100%">
              <el-radio-button
                :key="-2"
                :label="-2"
                class="radio-btn-4"
